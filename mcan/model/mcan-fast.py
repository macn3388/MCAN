...
class BaseBlock(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        reduction=8
        self.b1 = ops.FastCAResidualBlock(in_channels, out_channels, reduction=reduction)
        self.b2 = ops.FastCAResidualBlock(in_channels, out_channels, reduction=reduction)
        self.b3 = ops.FastCAResidualBlock(in_channels, out_channels, reduction=reduction)
...
class Net(nn.Module):
    def __init__(self, **kwargs):
        ...
        self.upsample = ops.my_UpsampleBlock(filter, 256, scale=scale, multi_scale=multi_scale, group=1)
        self.exit = nn.Conv2d(64, 3, 3, 1, 1, bias=False)

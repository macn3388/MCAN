...
class BaseBlock(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        reduction=4
        group = 4
        self.b1 = ops.CAEResidualBlock(in_channels, out_channels, group=group, reduction=reduction)
        self.b2 = ops.CAEResidualBlock(in_channels, out_channels, group=group, reduction=reduction)
        self.b3 = ops.CAEResidualBlock(in_channels, out_channels, group=group, reduction=reduction)
